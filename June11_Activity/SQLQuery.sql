...
----
select BookId,Title,a.AuthorID,Price,AuthorName from tbl_Books b join tbl_author a on a.AuthorID=b.AuthorID

----
select distinct a.AuthorID ,AuthorName from tbl_Books b join tbl_author a on a.AuthorID=b.AuthorID

create proc sp_FindAuthorIDbyName
@authorName varchar(20)
as
Begin
select AuthorID from tbl_author where AuthorName=@authorName
end

drop proc sp_FindAuthorIDbyName
exec  sp_FindAuthorIDbyName 'Chetan Bhagat'
